...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\TestJSON' => 'getTestJSONService',
    ...
    /**
     * Gets the public 'App\Controller\TestJSON' shared autowired service.
     *
     * @return \App\Controller\TestJSON
     */
    protected function getTestJSONService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\TestJSON.php';

        $this->services['App\\Controller\\TestJSON'] = $instance = new \App\Controller\TestJSON();

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\TestJSON', $this));
