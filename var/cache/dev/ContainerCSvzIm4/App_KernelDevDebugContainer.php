...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\db' => 'getDbService',
    ...
    /**
     * Gets the public 'App\Controller\db' shared autowired service.
     *
     * @return \App\Controller\db
     */
    protected function getDbService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\db.php';

        $this->services['App\\Controller\\db'] = $instance = new \App\Controller\db();

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\db', $this));
