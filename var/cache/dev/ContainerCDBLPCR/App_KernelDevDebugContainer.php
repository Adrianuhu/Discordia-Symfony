...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_User_Provider_Concrete_ExampleService()
    {
        ...
        return $this->privates['security.user.provider.concrete.example'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\Users', 'usernick', NULL);
    }
