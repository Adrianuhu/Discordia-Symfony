...
/* header.html.twig */
class __TwigTemplate_35fb2f56051290f2bc8690b9564cdfc6b58cc38fdb127cb6db8be866aa45d864 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  48 => 3,  43 => 2,);
    }

    public function getSourceContext()
    {
        return new Source("{#{ app.user.mail }#}
<a href=\"{{ path('categories') }}\">Home</a>
<a href=\"{{ path('categories') }}\">Cart</a>
{#<a href=\"{{ path('logout') }}\">Logout</a>#}", "header.html.twig", "C:\\Users\\Adrián\\Discordia-Symfony\\templates\\header.html.twig");
    }
}
